...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7811166069:AAFXuo_WPi1HiBz_APr4F-CuM_-8jCm7Wrw")
...
DB_NAME = os.environ.get("DATABASE_NAME", "@God_x_x_bot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://files.catbox.moe/mx6p7d.jpg")).split() #Required
